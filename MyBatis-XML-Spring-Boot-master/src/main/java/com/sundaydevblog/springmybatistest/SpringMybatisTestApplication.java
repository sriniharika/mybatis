...
public class SpringMybatisTestApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        userController.createUser("John Bravo", "jbravo@eds.com", "04324323287");
        userController.createUser("Abi Hoode", "abi.hoode@willsq.com", "04324323287");
        userController.createUser("Herbert M. Ridley", "HerbertMRidley@jourrapide.com", "713-519-6530");

        // This should throw an exception -> name is empty
        userController.createUser("", "abc@test.com", "07927139172");
